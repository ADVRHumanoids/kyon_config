_KYON_CLIENT_PROFILE_SCRIPT_DIR="$( cd "$( dirname "${BASH_SOURCE[0]}" )" &> /dev/null && pwd )"
...
source $_KYON_CLIENT_PROFILE_SCRIPT_DIR/../docker/kyon-noble-ros2/setup.sh
...
function kyon_connect_zenoh() {
    cd $_KYON_CLIENT_PROFILE_SCRIPT_DIR/../docker/kyon-noble-ros2 
